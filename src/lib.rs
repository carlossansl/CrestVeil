...
#[derive(Debug)]
pub struct CrestVeilProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CrestVeilProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CrestVeil processing");
    
    let mut processor = CrestVeilProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CrestVeilProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CrestVeilProcessor::new(false);
